...
////类别码
//enum symtype {
//	SYM_NULL,	SYM_IDENTIFIER,	SYM_NUMBER,	SYM_PLUS,	SYM_MINUS,	SYM_TIMES,	SYM_SLASH,	SYM_EQU,	SYM_NEQ,	SYM_LES,	SYM_LEQ,	SYM_GTR,	SYM_GEQ,	SYM_LPAREN,	SYM_RPAREN,	SYM_COMMA,	SYM_SEMICOLON,	SYM_PERIOD,	SYM_BECOMES,   
...
//	"odd", "procedure", "then", "var", "while"
//};
//去掉procedure、odd、call 加上program
// "PROGRAM", "BEGIN", "END", "CONST", "VAR", "WHILE", "DO", "IF", "THEN"
char* keyword[NRW + 1] = {
	"", /* place holder */
	"PROGRAM", "BEGIN", "END", "CONST", "VAR", "WHILE", "DO", "IF", "THEN"
...
//类别码
//enum symtype {
//	SYM_NULL, SYM_IDENTIFIER, SYM_NUMBER, SYM_PLUS, SYM_MINUS, 
//	SYM_TIMES, SYM_SLASH, SYM_ODD, SYM_EQU, SYM_NEQ, 
//	SYM_LES, SYM_LEQ, SYM_GTR, SYM_GEQ, SYM_LPAREN, 
//	SYM_RPAREN, SYM_COMMA, SYM_SEMICOLON, SYM_PERIOD, SYM_BECOMES,
//	SYM_BEGIN, SYM_END, SYM_IF, SYM_THEN, SYM_WHILE, 
//	SYM_DO, SYM_CALL, SYM_CONST, SYM_VAR, SYM_PROCEDURE
//};
enum symtype {
